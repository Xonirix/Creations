...
document.getElementById("machineWarning").style.display="inline-block"
    ...
    document.getElementById("creationPointAmount").innerHTML = gameData.creationPoints + " Creation Points (per click: "+ gameData.creationPointsPerClick + ")"
    ...
    document.getElementById("rebirthText").innerHTML= gameData.rebirthPoints +" Rebirth Points (per Rebirth: "+ gameData.rebirthPointsPerRebirth+ ")"
